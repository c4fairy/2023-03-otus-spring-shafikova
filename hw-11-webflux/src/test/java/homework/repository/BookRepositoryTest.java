...
@ComponentScan({"ru.otus.education.web.flux.reactivemongo.repo"})
...
class BookRepositoryTest {
    ...
    void shouldSetIdOnSave() {
        Mono<Book> bookMono = repository.save(new Book(1L, BOOK_TITLE, new Author(AUTHOR_NAME), new Genre(GENRE_NAME), null));
