...
import ru.otus.domain.DatabaseSequence;
...
public class DatabaseChangeLog {
    @ChangeSet(order = "001", id = "addMoreBooks", author = "Dmitriy")
    public void insertBooks(MongockTemplate mongoTemplate) {
        Genre genre1 = new Genre(BigInteger.valueOf(1), "genre1");
        Genre genre2 = new Genre(BigInteger.valueOf(2), "genre2");
        Author author1 = new Author(BigInteger.valueOf(1), "author1");
        Author author2 = new Author(BigInteger.valueOf(2), "author2");
        Author author3 = new Author(BigInteger.valueOf(3), "author3");
        Comment comment1 = new Comment(BigInteger.valueOf(1), "new comment 1");
        Comment comment2 = new Comment(BigInteger.valueOf(2), "comment 2");
        Comment comment3 = new Comment(BigInteger.valueOf(3), "comment 3");
        Comment comment4 = new Comment(BigInteger.valueOf(4), "comment 4");
        ...
        Book book1 = new Book(BigInteger.valueOf(1), "book1", author1, genre1, list1);
        Book book2 = new Book(BigInteger.valueOf(2), "book2", author1, genre2, list2);
        Book book3 = new Book(BigInteger.valueOf(3), "book3", author2, genre1, null);
        Book book4 = new Book(BigInteger.valueOf(4), "book4", author2, genre2, null);
        Book book5 = new Book(BigInteger.valueOf(5), "book5", author3, genre2, null);
